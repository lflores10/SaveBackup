...
function activate(context) {
    console.log('Congratulations, your extension "savebackuporiginal" is now active!');

    var disposable = vscode.commands.registerTextEditorCommand('extension.savebackuporiginal.backupFile', (textEditor, edit) => {
    ...
    vscode.workspace.onWillSaveTextDocument((event ) => {
        ...
        var oConf = vscode.workspace.getConfiguration('savebackuporiginal.conf');
            ...
            if (ExistFolder) {
                try {
                    ...
                    if (new RegExp(oConf.fileNameMatch).test(sFileName)) {
                        ...
                        event.waitUntil($$fs.copyFileSync(sFilePath, sBakPath))
                    ...
                    vscode.window.showErrorMessage(`extension.savebackuporiginal : ${error.message}`);
                }
            }
        }
    });
